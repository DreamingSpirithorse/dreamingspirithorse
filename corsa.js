...
var Notaerava = document.createTextNode(`click the two imgs to the left to hear songs.  i have 90trillion songs and some with much more progress and niceness than these BUT these are very anthemable and proud.  the nonpiano one is just starting, but the lyrics i hear in it are 'free forever, from sea to sea...' and that's pretty patriotic.  I usually do supermagic songs but basically whatever energy and patterns we want can happen via song.  Should probably show you a more complete song so you see quality level, BUT NOPE.  Would make commercials the kids run to the tv like 'oh yeah this commercial again!' and love the music.`);
